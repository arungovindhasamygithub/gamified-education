...
class User(AbstractUser):
    ...
    def update_level(self):
        ...
        Level 1 (Bronze): 0-99 points
        Level 2 (Silver): 100-299 points
        Level 3 (Gold): 300+ points
        """
        ...
        # If level changed, save immediately
    ...
    def record_quiz_completion(self, score, total_questions):
        ...
        self.total_correct_answers += score // 20  # Assuming 20 points per correct answer
